...
<div style="max-width: 1200px; margin: 2rem auto; border: 2px solid #454545; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);">
<div id="repl-container" style="background: #1e1e1e; padding: 20px; min-height: 500px; max-height: 700px; overflow-y: auto; position: relative;">
...
# Why a v2?
Eldritch v1 was based on the starlark-rust. While starlark-rust is excellent for build systems and helped us getting and going quickly, it enforces constraints that make sense for builds but fight against the nature of offensive operations.
